        ...
        <div className="rounded-[32px] border border-[var(--border-subtle)] bg-white px-8 py-10 shadow-[0_18px_60px_rgba(13,27,42,0.08)]">
          ...
          <Section title="11. Privacy and Data Protection">
            ...
            <p>
              ...
              <a href="mailto:privacy@styld.co.ke" className="text-[var(--color-accent)] underline">
                {"privacy@styld.co.ke"}
              </a>
              {"."}
            </p>
          ...
          <Section title="17. Contact">
            <div className="rounded-[18px] bg-[var(--surface-card)] px-5 py-5">
              ...
              <div className="mt-4 space-y-2 text-sm">
                <p>
                  {"Legal: "}
                  <a href="mailto:legal@styld.co.ke" className="text-[var(--color-accent)] underline">
                    {"legal@styld.co.ke"}
                  </a>
                </p>
                <p>
                ...
                <p>
                  {"Payment disputes: "}
                  <a href="mailto:payments@styld.co.ke" className="text-[var(--color-accent)] underline">
