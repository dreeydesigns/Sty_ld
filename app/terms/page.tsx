...
export const metadata: Metadata = {
  ...
  description: "Styld Terms and Conditions of Use — Kenya",
};
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mb-10 overflow-hidden rounded-[32px] bg-[var(--ms-plum)] px-8 py-10 text-white shadow-[0_24px_80px_rgba(58,24,58,0.3)]">
          ...
          <p className="mt-3 text-sm leading-7 text-white/70">
            {"Effective Date: [To be inserted by Styld]"}
            <br />
            {"Last Updated: [To be inserted by Styld]"}
          </p>
          <p className="mt-5 rounded-[18px] bg-white/10 px-5 py-4 text-sm leading-7 text-white/80">
            {"Please read these Terms carefully before using the Styld platform. By accessing or using any part of the Platform, or by creating an account, you confirm that you have read, understood, and agreed to be bound by these Terms. If you do not agree, you must not use the Platform."}
          </p>
        </div>
        ...
        <div className="rounded-[32px] border border-[var(--ms-border)] bg-white px-8 py-10 shadow-[0_18px_60px_rgba(13,27,42,0.08)]">
          ...
          <Section title="1. About Styld">
            <p>
              {"Styld is a digital marketplace platform operated by Styld Limited, a company registered in Kenya (\"Styld\", \"we\", \"us\", \"our\"). The Platform connects clients seeking beauty services, beauty professionals offering services, salons and spas, beauty product shops, and delivery service providers."}
            </p>
            <p>
              <strong>{"Styld is a technology intermediary only."}</strong> {"We do not provide beauty services, sell beauty products, or provide delivery services directly. We provide the technology platform through which independent parties transact."}
            </p>
          </Section>
          ...
          <Section title="3. User Content and Listings">
            ...
            <p>
              {"Styld reserves the right to remove any User Content at any time, without notice, if we determine it violates these Terms or any applicable law. Styld is not obligated to monitor User Content but may do so at our discretion."}
            </p>
          </Section>
          ...
          <Section title="5. Payment Terms">
            <p>
              {"All transactions on the Platform are conducted in Kenyan Shillings (KES) unless otherwise stated. By making a payment through the Platform, you authorise Styld to process the transaction on your behalf through our designated payment processors (including Safaricom M-Pesa via the Daraja API and Stripe)."}
            </p>
            <p>
            ...
            <p>
              {"Styld applies a commission on marketplace transactions as specified in the applicable commission schedule. This commission is deducted from the seller's payout and is non-negotiable. By selling on the Platform, you explicitly agree to the applicable commission deduction."}
            </p>
            <p>
              {"You are responsible for all applicable taxes on your earnings from the Platform, including VAT and income tax, in accordance with the Kenya Revenue Authority (KRA) requirements. Styld will issue transaction records but is not responsible for your tax compliance."}
            </p>
          </Section>

          <Section title="6. Escrow and Payout Terms">
            <p>
              {"For product purchases on the Counter marketplace, payments are held in escrow by Styld until the buyer confirms receipt of goods, or until the automatic release period (72 hours after confirmed delivery) expires."}
            </p>
            <p>
              {"Styld acts as a payment intermediary only in this process and does not guarantee the quality, safety, or accuracy of any product. Styld's decision in all disputes is final. Styld will not be liable for delays in payout caused by issues with third-party payment processors including Safaricom or Stripe."}
            </p>
            <p>
              {"Sellers must maintain a valid and active M-Pesa number registered in their name for payouts. Styld reserves the right to withhold payment if fraud or policy violation is suspected pending investigation."}
            </p>
          </Section>
          ...
          <Section title="7. No Delivery Services">
            <div className="rounded-[18px] border border-[var(--ms-border)] bg-[var(--ms-soft-bg)] px-5 py-4">
              ...
              <p className="mt-2">
                {"Styld does not provide delivery services. The Platform may facilitate connections between Shops with Shop+ subscriptions and independent Delivery account holders, but Styld is not a party to any delivery transaction."}
              </p>
              <p className="mt-3">
                {"Delivery partners are independent contractors. Styld makes no warranties regarding delivery timelines, product condition upon delivery, or the conduct of delivery partners. If a product is damaged, lost, delayed, or not delivered, the matter is between the buyer, the seller, and the delivery partner."}
              </p>
              <p className="mt-3">
                {"Styld will provide dispute facilitation but accepts no financial liability for delivery failures. By completing a product purchase, you acknowledge and accept this limitation."}
              </p>
            </div>
          </Section>
          ...
          <Section title="8. Limitation of Liability">
            <p>
              {"Styld provides the Platform on an \"as is\" and \"as available\" basis without warranty of any kind. To the maximum extent permitted by Kenyan law, Styld expressly disclaims all warranties, express or implied, including but not limited to: implied warranties of merchantability, fitness for a particular purpose, and non-infringement."}
            </p>
            <p>{"Styld shall not be liable for:"}</p>
            <ul className="ml-6 list-disc space-y-2">
            ...
            <p>
              {"In no event shall Styld's total aggregate liability for any claim exceed the amount paid by you to Styld in the 12-month period preceding the claim, or KES 10,000, whichever is lower. Nothing in these Terms excludes liability for death or personal injury caused by Styld's gross negligence, or liability for fraud."}
            </p>
          </Section>
          ...
          <Section title="9. User Liability — Products and Services">
            ...
            <p>
              {"By using the Platform, you agree to indemnify, defend, and hold harmless Styld Limited, its directors, officers, employees, agents, and affiliates from and against any and all claims, liabilities, damages, losses, costs, and expenses (including reasonable legal fees) arising out of or in connection with your use of the Platform, your User Content, your violation of these Terms, or your violation of any rights of another party."}
            </p>
          </Section>

          <Section title="10. Intellectual Property">
            <p>
              {"All intellectual property rights in the Platform — including software, design, trademarks, logos, and content created by Styld — belong exclusively to Styld Limited."}
            </p>
            <p>
              {"You grant Styld a non-exclusive, royalty-free, worldwide licence to use, display, and distribute your User Content solely for the purpose of operating and promoting the Platform. This licence terminates when you delete your content or your account."}
            </p>
            <p>
              {"You may not reproduce, distribute, modify, or create derivative works of any Styld content without express written permission."}
            </p>
          </Section>

          <Section title="11. Privacy and Data Protection">
            <p>
              {"Styld processes your personal data in accordance with the Kenya Data Protection Act, 2019 (Act No. 24 of 2019) and our Privacy Policy, which forms part of these Terms by reference."}
            </p>
            <p>
              ...
              <a href="mailto:privacy@styld.co.ke" className="text-[var(--ms-rose)] underline">
                {"privacy@styld.co.ke"}
              </a>
              {"."}
            </p>
            <p>
              {"Styld will not sell your personal data to third parties. We may share data with service providers, payment processors, and law enforcement when legally required."}
            </p>
          </Section>
          ...
          <Section title="12. Reviews and Ratings">
            ...
            <p>
              {"Styld reserves the right to remove any review it determines to be false, manipulative, or in violation of these Terms. Users who submit false reviews may be held civilly liable for defamation under the Defamation Act (Cap 36) of Kenya."}
            </p>
          </Section>

          <Section title="13. Account Suspension and Termination">
            <p>{"Styld may suspend or terminate your account at any time, with or without notice, if:"}</p>
            <ul className="ml-6 list-disc space-y-2">
            ...
            <p>
              {"Upon termination, your right to access the Platform ceases immediately. Styld is not liable to you or any third party for any consequences of account termination."}
            </p>
          </Section>

          <Section title="14. Dispute Resolution">
            <p>
              {"Any dispute arising out of or in connection with these Terms shall first be submitted to Styld's internal dispute resolution process. If unresolved within 30 days, disputes shall be referred to mediation before the Nairobi Centre for International Arbitration (NCIA)."}
            </p>
            <p>
              {"If mediation fails, disputes shall be resolved by arbitration under the Arbitration Act, Cap 49 of Kenya. The seat of arbitration shall be Nairobi. The language of arbitration shall be English. The arbitrator's decision shall be final and binding."}
            </p>
            <p>
              {"Nothing in this clause prevents Styld from seeking injunctive or other equitable relief from a competent Kenyan court."}
            </p>
          </Section>
          ...
          <Section title="16. Changes to These Terms">
            <p>
              {"Styld reserves the right to modify these Terms at any time. Changes take effect 14 days after notice is posted on the Platform or sent to your registered email. Continued use of the Platform after the effective date constitutes acceptance of the revised Terms."}
            </p>
            <p>
              {"These Terms are intended to address not only present circumstances but also future technological, legal, and commercial developments. Where these Terms do not explicitly address a specific situation, the spirit and intent of these Terms — to protect the integrity of the Platform, the safety of users, and the fair operation of commerce — shall govern. Styld's interpretation of these Terms in any such situation shall be final."}
            </p>
          </Section>

          <Section title="17. Contact">
            <div className="rounded-[18px] bg-[var(--ms-soft-bg)] px-5 py-5">
              <p className="font-semibold text-[var(--ms-navy)]">{"Styld Limited"}</p>
              <p className="mt-1 text-[var(--ms-mauve)]">{"Nairobi, Kenya"}</p>
              <div className="mt-4 space-y-2 text-sm">
                <p>
                  {"Legal: "}
                  <a href="mailto:legal@styld.co.ke" className="text-[var(--ms-rose)] underline">
                    {"legal@styld.co.ke"}
                  </a>
                </p>
                <p>
                ...
                <p>
                  {"Payment disputes: "}
                  <a href="mailto:payments@styld.co.ke" className="text-[var(--ms-rose)] underline">
                    {"payments@styld.co.ke"}
                  </a>
                </p>
              </div>
            </div>
