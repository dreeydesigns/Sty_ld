...
export default function DeliveryProfilePage() {
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center gap-6 bg-[var(--surface-card)] px-4 text-center">
      <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[var(--color-warning-bg)]/10">
        <Truck className="h-8 w-8 text-[var(--color-warning)]" />
      </div>
      <div>
      ...
      <Link
        href="/auth/sign-up"
        className="rounded-full bg-[var(--color-warning-bg)] px-6 py-3 text-sm font-semibold text-white transition hover:brightness-110"
      >
        Back to sign up
      </Link>
    </div>
