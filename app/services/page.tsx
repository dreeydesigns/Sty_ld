          ...
          <div className="grid gap-6 xl:grid-cols-[minmax(0,0.66fr)_minmax(320px,0.34fr)] xl:items-end">
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-2">
                <Link
                  className="rounded-full bg-[var(--ms-magenta-bg)] px-4 py-2 text-sm font-semibold text-white shadow-[0_14px_32px_rgba(217,70,239,0.22)] transition hover:bg-[var(--color-primary)]"
                  href="#deals"
                >
                  View deals first
                </Link>
                <Link
                  className="rounded-full border border-[var(--border-subtle)] bg-white px-4 py-2 text-sm font-semibold text-[var(--color-primary)] transition hover:border-[var(--ms-gold)] hover:bg-[var(--surface-card)]"
                ...
                {categories.slice(0, 4).map((category) => (
                  <Link
                    className="rounded-full border border-[var(--border-subtle)] bg-white px-4 py-2 text-sm font-semibold text-[var(--color-primary)] transition hover:border-[var(--ms-rose)]/35 hover:bg-[var(--ms-petal)]"
                    href="#services-picker"
                    key={category}
                  >
                    {category}
            ...
            <div className="rounded-[28px] bg-white/86 p-5 shadow-[0_16px_38px_rgba(132,36,92,0.1)]">
              ...
              <div className="mt-5">
                <Link
                  className="inline-flex items-center justify-center rounded-full bg-[var(--ms-navy)] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[var(--color-primary)]"
