    ...
    >
      <div className="flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <section className="mx-auto max-w-3xl overflow-hidden rounded-[38px] border border-[var(--border-subtle)] bg-white p-6 text-center shadow-[0_22px_60px_rgba(13,27,42,0.1)] sm:p-8">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-[var(--surface-elevated)] text-[var(--color-accent)] animate-bounce-subtle">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            <Link
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-full bg-[linear-gradient(135deg,var(--color-ink),var(--color-secondary))] px-5 text-sm font-semibold text-white shadow-[0_16px_34px_rgba(232,62,140,0.15)] hover:opacity-90 transition-opacity"
              href="/profile"
            >
          ...
          <p className="mt-6 text-xs leading-6 text-[var(--color-secondary)]">
