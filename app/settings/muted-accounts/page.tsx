        ...
        {muted.length === 0 ? (
          ...
          <div className="overflow-hidden rounded-[18px] bg-white shadow-[0_1px_6px_rgba(13,27,42,0.06)]">
            {muted.map((entry, i) => (
              ...
              >
                <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[var(--surface-card)] text-[15px] font-bold text-[var(--ms-mauve)]">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 rounded-full border border-[var(--border-subtle)] px-3 py-1.5 text-[12px] font-semibold text-[var(--ms-mauve)] transition hover:border-[var(--ms-plum)] hover:text-[var(--color-primary)]"
                >
