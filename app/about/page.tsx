    ...
    <main className="min-h-screen bg-[var(--ms-soft-bg)] px-4 py-10 text-[var(--ms-charcoal)]">
      <div className="mx-auto max-w-md">
        ...
        <div className="mb-10 flex flex-col items-center text-center">
          <div
            className="mb-5 flex h-24 w-24 items-center justify-center rounded-[28px] text-3xl font-black text-white shadow-[0_16px_48px_rgba(58,24,58,0.30)]"
            style={{ background: "linear-gradient(135deg, var(--ms-plum), var(--ms-gold))" }}
          >
            S
          </div>
          <h1 className="text-[28px] font-black tracking-[-0.02em] text-[var(--ms-navy)] font-display">
            Styld
          </h1>
        ...
        <div className="mt-4 space-y-3">
          <div className="rounded-[20px] border border-[var(--ms-border)] bg-white px-5 py-4 shadow-[0_1px_6px_rgba(13,27,42,0.05)]">
            ...
            <p className="mt-1 text-[14px] font-semibold text-[var(--ms-navy)]">Styld Limited</p>
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          <p className="text-[11px] text-[var(--ms-mauve)]">© 2026 Styld Limited</p>
        </div>
      </div>
    </main>
  );
